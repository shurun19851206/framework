...
public class BeanInvokingJobDetailFactoryBean implements FactoryBean, BeanNameAware, InitializingBean, ApplicationContextAware
{
    ...
    /** 
     * Used by <code>afterPropertiesSet</code> to set the JobDetail.requestsRecovery property.  Default: true<BR>
    ...
    public void setJobListenerNames(String[] jobListenerNames)
    {
        if(jobListenerNames != null){
            this.jobListenerNames = Arrays.copyOf(jobListenerNames, jobListenerNames.length);
        }
    }
